...
week2_sleep <-c(7.1,7.4,79,6.5,8.1,8.2,8.9)
...
factor_recommendations_vector <- factor(recommendations_vector, levels=c("no", "neutral", "yes"), ordered=TRUE)
